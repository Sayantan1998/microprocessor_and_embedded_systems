...
void LCD_plot(void){
  if(digitalRead(74)==0){
    ...
    for(int i=0;i<MAXDOTS;i++) myScreen.dRectangle(10+(i), 40+ (pwm_data[i]<<5), 1, 1, whiteColour);   
  }
}
